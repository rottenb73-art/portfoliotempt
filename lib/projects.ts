...
export const projects: Project[] = [
  ...
  },
  {
    ...
    media: [
      ...
      { type: 'image', src: `${BASE}/${enc('BATH HOUSE, Fall 2025/Model Pics/chunkmodel1.jpg')}`, alt: 'Chunk Model — View 1', category: 'Model Pics' },
      { type: 'image', src: `${BASE}/${enc('BATH HOUSE, Fall 2025/Model Pics/chunkmodel2.jpg')}`, alt: 'Chunk Model — View 2', category: 'Model Pics' },
      { type: 'image', src: `${BASE}/${enc('BATH HOUSE, Fall 2025/Model Pics/chunkmodel3.jpg')}`, alt: 'Chunk Model — View 3', category: 'Model Pics' },
      { type: 'image', src: `${BASE}/${enc('BATH HOUSE, Fall 2025/Model Pics/chunkmodel4.jpg')}`, alt: 'Chunk Model — View 4', category: 'Model Pics' },
    ],
  },
  {
